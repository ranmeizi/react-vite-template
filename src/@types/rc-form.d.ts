declare module "rc-form" {
  import { FunctionComponent, ComponentClass, Mixin, ReactNode } from "react";
  ...
  export interface WrappedFormMethods {
    ...
    validateFields<T = ValidateErrors, U = any>(
      fieldNames: string[],
      options: ValidateFieldsOptions,
      callback: (errors: T, values: U) => void
    ): Promise<any>;
    validateFields(
      fieldNames: string[],
      options: ValidateFieldsOptions
  ...
  export type WrappedFormClass<P> = (ComponentClass<P> | FunctionComponent<P>) &
    WrappedFormMethods;
